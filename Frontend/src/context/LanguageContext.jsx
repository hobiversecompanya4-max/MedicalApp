...
const translations = {
  ...
  'Order successfully placed': 'ऑर्डर सफलतापूर्वक किया गया',
  'Your order has been placed successfully. Login to manage and track your order.': 'आपका ऑर्डर सफलतापूर्वक किया गया है। ऑर्डर प्रबंधित और ट्रैक करने के लिए लॉगिन करें।',
  'Order ID': 'ऑर्डर आईडी',
  'Close order confirmation': 'ऑर्डर पुष्टि बंद करें',
  ...
  'Upload your prescription and let our pharmacist team help make your order simple, safe, and convenient.': 'अपना प्रिस्क्रिप्शन अपलोड करें और हमारी फ़ार्मेसी टीम को आपका ऑर्डर आसान, सुरक्षित और सुविधाजनक बनाने में मदद करने दें।',
